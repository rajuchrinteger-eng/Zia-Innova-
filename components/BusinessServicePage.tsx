        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-up">
              <h2 className="text-4xl font-bold text-slate-900 mb-8">About Our Business Services</h2>
              <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
                <p>
                  Our Marketing Business Services are built to address the real-world challenges faced by businesses today. We offer end-to-end support covering marketing, branding, technology, and skill development.
                </p>
                <p>
                  By positioning ourselves as a complete business partner, we allow businesses to focus on their core growth while we handle the strategy, visual communication, and technical automation required to thrive in a competitive landscape.
                </p>
              </div>
            </div>
            <div className="relative animate-fade-up" style={{ animationDelay: '0.2s' }}>
              <div className="aspect-square bg-slate-50 rounded-[100px] flex items-center justify-center p-12 relative overflow-hidden">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-orange-50 rounded-full -z-10 animate-pulse"></div>
                <img 
                  src="https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&q=80&w=800" 
                  alt="Business Meeting" 
                  className="rounded-[80px] shadow-2xl z-10 object-cover aspect-square"
                />
              </div>
            </div>
          </div>
