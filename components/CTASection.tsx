  ...
  return (
    <section className="py-24 px-6">
      <div className="container mx-auto">
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-[60px] p-12 md:p-24 text-center text-white relative overflow-hidden">
          {/* Decorative Circles */}
          ...
          <div className="relative z-10">
            <h2 className="text-4xl md:text-5xl font-bold mb-8">Let’s Build the Future of <br className="hidden md:block"/> Your Business Together</h2>
