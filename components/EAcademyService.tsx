        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 animate-fade-up">
              ...
              <p className="text-xl md:text-2xl text-slate-700 font-medium mb-10 leading-relaxed">
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-up">
              <h2 className="text-4xl font-bold text-slate-900 mb-8">About E-Academy</h2>
              <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
                <p>
                  E-Academy was created to bridge the gap between academic learning and industry requirements. The platform focuses on skill-based education, real-world exposure, and guided learning journeys.
                </p>
                <p>
                  The collaboration with Rinteger brings deep expertise in digital marketing, technology, and training delivery, ensuring learners receive industry-aligned education that makes them job-ready from day one.
                </p>
              </div>
            </div>
            <div className="relative animate-fade-up" style={{ animationDelay: '0.2s' }}>
              <div className="aspect-video bg-white rounded-[60px] p-2 shadow-2xl overflow-hidden group relative">
                <img 
                  src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80&w=1200" 
                  alt="Learning Interface" 
                  className="w-full h-full object-cover rounded-[58px] group-hover:scale-105 transition-transform duration-700"
                />
                <div className="absolute inset-0 flex items-center justify-center bg-black/10 group-hover:bg-black/5 transition-all">
                  <div className="w-20 h-20 bg-emerald-600 text-white rounded-full flex items-center justify-center text-2xl shadow-2xl cursor-pointer hover:scale-110 transition-transform">
