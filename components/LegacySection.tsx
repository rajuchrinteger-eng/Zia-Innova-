        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <button 
              ...
              className="text-blue-600 font-bold flex items-center hover:translate-x-2 transition-transform duration-300"
            >
          ...
          <div className="grid grid-cols-2 gap-6">
            {stats.map((stat, i) => (
              <div key={i} className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-500 group">
                <div className={`text-3xl mb-4 ${stat.color} group-hover:scale-110 transition-transform`}>
