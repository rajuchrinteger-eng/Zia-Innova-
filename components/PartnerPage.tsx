    ...
    <div className="bg-white">
      ...
      <section className="relative pt-24 pb-32 overflow-hidden bg-slate-900 text-white">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center animate-fade-up">
           ...
           <p className="text-xl md:text-2xl text-slate-300 font-light mb-10 max-w-4xl mx-auto leading-relaxed">
            ...
            <div className="bg-white border border-slate-200 rounded-[40px] p-10 hover:shadow-2xl hover:border-purple-200 transition-all duration-300 group relative overflow-hidden">
               ...
               <div className="relative z-10">
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-slate-900">Global Career Development (Rinteger)</h3>
                  ...
                  <button 
                    ...
                    className="inline-flex items-center px-8 py-3 bg-purple-600 text-white rounded-full font-bold text-sm hover:bg-purple-700 transition-all shadow-lg shadow-purple-200"
                  >
              ...
              <div className="md:col-span-2 bg-slate-900 text-white p-10 flex flex-col justify-between relative overflow-hidden">
                ...
                <div className="relative z-10">
                   ...
                   <div className="space-y-4">
                     ...
                     <div className="flex items-center space-x-3 text-sm"><i className="fa-solid fa-phone text-blue-400"></i> <span>+91 8438355305</span></div>
                   </div>
                </div>
