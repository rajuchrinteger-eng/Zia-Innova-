          ...
          {softwareServices.map((s, i) => (
            ...
            >
              ...
              <div className="h-48 overflow-hidden relative">
                ...
                <div className="absolute top-4 left-4 w-12 h-12 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center text-white border border-white/30">
